...
##### 17-19. Почистив все, та завантажив створені імеджі в Docker.
###### - Makefile краще використовувати для певних дій з системою
###### - Docker-compose краще використовувати коли маємо справу безпосередньо з докером
##### 20. Створив docker-compose.yml в Lab_4
